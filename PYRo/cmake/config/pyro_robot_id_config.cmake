...
set(DISPLAY_ID "${ROBOT_ID}")
    ...
    # 映射名称（支持数字或字符串形式）
    if(ROBOT_ID STREQUAL "TEST_ROBOT_ID")
        set(ROBOT_ID_NUM ${TEST_ROBOT_ID})
    elseif(ROBOT_ID STREQUAL "HERO_ID")
        set(ROBOT_ID_NUM ${HERO_ID})
    elseif(ROBOT_ID STREQUAL "ENGINEER_ID")
        set(ROBOT_ID_NUM ${ENGINEER_ID})
    elseif(ROBOT_ID STREQUAL "INFANTRY1_ID")
        set(ROBOT_ID_NUM ${INFANTRY1_ID})
    elseif(ROBOT_ID STREQUAL "INFANTRY2_ID")
        set(ROBOT_ID_NUM ${INFANTRY2_ID})
    elseif(ROBOT_ID STREQUAL "SENTRY_ID")
        set(ROBOT_ID_NUM ${SENTRY_ID})
    elseif(ROBOT_ID STREQUAL "UAV_ID")
        set(ROBOT_ID_NUM ${UAV_ID})
    elseif(ROBOT_ID STREQUAL "DARTS_ID")
        set(ROBOT_ID_NUM ${DARTS_ID})
    elseif(ROBOT_ID STREQUAL "RADAR_ID")
        set(ROBOT_ID_NUM ${RADAR_ID})
    elseif(ROBOT_ID STREQUAL "SUB_HERO_ID")
        set(ROBOT_ID_NUM ${SUB_HERO_ID})
    elseif(ROBOT_ID STREQUAL "SUB_ENGINEER_ID")
        set(ROBOT_ID_NUM ${SUB_ENGINEER_ID})
    elseif(ROBOT_ID STREQUAL "SUB_INFANTRY_ID")
        set(ROBOT_ID_NUM ${SUB_INFANTRY_ID})
    elseif(ROBOT_ID STREQUAL "SUB_SENTRY_ID")
        set(ROBOT_ID_NUM ${SUB_SENTRY_ID})
    else()
        set(ROBOT_ID_NUM "${ROBOT_ID}")
    endif()

    if(ROBOT_ID_NUM EQUAL 0)
        set(ROBOT_NAME "TEST_ROBOT")
    elseif(ROBOT_ID_NUM EQUAL 1)
        set(ROBOT_NAME "HERO")
    elseif(ROBOT_ID_NUM EQUAL 2)
        set(ROBOT_NAME "ENGINEER")
    elseif(ROBOT_ID_NUM EQUAL 3)
        set(ROBOT_NAME "INFANTRY1")
    elseif(ROBOT_ID_NUM EQUAL 4)
        set(ROBOT_NAME "INFANTRY2")
    elseif(ROBOT_ID_NUM EQUAL 5)
        set(ROBOT_NAME "SENTRY")
    elseif(ROBOT_ID_NUM EQUAL 6)
        set(ROBOT_NAME "UAV")
    elseif(ROBOT_ID_NUM EQUAL 7)
        set(ROBOT_NAME "DARTS")
    elseif(ROBOT_ID_NUM EQUAL 8)
        set(ROBOT_NAME "RADAR")
    elseif(ROBOT_ID_NUM EQUAL 10)
        set(ROBOT_NAME "SUB_HERO")
    elseif(ROBOT_ID_NUM EQUAL 20)
        set(ROBOT_NAME "SUB_ENGINEER")
    elseif(ROBOT_ID_NUM EQUAL 30)
        set(ROBOT_NAME "SUB_INFANTRY")
    elseif(ROBOT_ID_NUM EQUAL 50)
...
if(NOT DEFINED ROBOT_ID)
    ...
    if(DEFINED ROBOT_ID_NUM)
        add_compile_definitions(ROBOT_ID=${ROBOT_ID_NUM})
    else()
